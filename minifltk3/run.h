//
// "$Id: run.h 9893 2013-04-19 13:52:28Z manolo $"
//
...
extern unsigned char scheme_type_;
...
void arg_param(int *argc, char **argv[]); // add by cyantree, for ios
/**
 ...
 */
inline void event_clicks(int i)
{
	e_clicks = i;
}
/**
 ...
 */
inline void event_is_click(int i)
{
	e_is_click = i;
}
/**
 ...
 */
inline unsigned int event_button()
{
	return e_keysym-fltk3::MouseButton;
}
/**
 ...
 */
inline unsigned event_state()
{
	return e_state;
}
/** See int event_state() */
inline unsigned event_state(unsigned i)
{
	return e_state&i;
}
/**
...
inline fltk3::Widget* belowmouse()
{
	return belowmouse_;
}
...
inline fltk3::Widget* selection_owner()
{
...
//void set_boxtype(fltk3::Box *to, fltk3::Box* from);
...
inline void set_abort(fltk3::AbortHandler f)
{
	fatal = f;
}
...
inline void set_atclose(fltk3::AtcloseHandler f)
{
	atclose = f;
}
/**   @} */
...
inline int event_shift()
{
	return e_state&fltk3::SHIFT;
}
/** Returns non-zero if the Control key is pressed. */
inline int event_ctrl()
{
	return e_state&fltk3::CTRL;
}
/** Returns non-zero if the fltk3::COMMAND key is pressed, either fltk3::CTRL or on OSX fltk3::META. */
inline int event_command()
{
	return e_state&fltk3::COMMAND;
}
/** Returns non-zero if the Alt key is pressed. */
inline int event_alt()
{
	return e_state&fltk3::ALT;
}
/**
 ...
 */
inline int event_button1()
{
	return e_state&fltk3::BUTTON1;
}
/**
 Returns non-zero if button 2 is currently held down.
 For more details, see fltk3::event_buttons().
 */
inline int event_button2()
{
	return e_state&fltk3::BUTTON2;
}
/**
 Returns non-zero if button 3 is currently held down.
 For more details, see fltk3::event_buttons().
 */
inline int event_button3()
{
	return e_state&fltk3::BUTTON3;
}
/**   @} */
 ...
 */
inline void set_idle(fltk3::OldIdleHandler cb)
{
	idle = cb;
}

/** See grab(fltk3::Window*) */
inline void grab(fltk3::Window& win)
{
	grab(&win);
}
...
/**
 ...
 for all widgets.
 */
inline void visible_focus(int v)
{
...
/**
 ...
 cut/paste shortcut.
 */
inline void dnd_text_ops(int v)
{
...
//
// End of "$Id: run.h 9893 2013-04-19 13:52:28Z manolo $".
//
