...
void fltk3::sleep(double seconds)
{
	fltk3::usleep((unsigned long long) (seconds*1000000));
}

/** Make the current thread to sleep for n milliseconds */
void fltk3::msleep(unsigned long milliseconds)
{
#ifdef WIN32
...
void fltk3::usleep(unsigned long long microseconds) 
//void fltk3::usleep(unsigned long microseconds) 
