//
// "$Id: FileBrowser.cxx 9330 2012-04-09 08:53:49Z manolo $"
//
	...
	for (t = line->txt, ptr = fragment; *t != '\0'; t ++)
		if (*t == '\n') {
			...
			*ptr = '\0';
			...
			fltk3::draw(fragment, X + width, Y, cW, fltk3::height(), (fltk3::Align)(fltk3::ALIGN_LEFT | fltk3::ALIGN_CLIP), 0, 0);

			// Advance to the next column...
			column ++;
			if (columns) {
				for (i = 0, width = 0; i < column && columns[i]; i ++) width += columns[i];
			} else {
...
//
// End of "$Id: FileBrowser.cxx 9330 2012-04-09 08:53:49Z manolo $".
//
