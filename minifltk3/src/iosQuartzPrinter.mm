//
// "$Id: cocoaQuartzPrinter.mm 9929 2013-05-30 09:46:37Z manolo $"
//
...
int fltk3::SystemPrinter::start_page(void) {
	...
	if (orientation == kPMPortrait) CGContextTranslateCTM(fl_gc, margins.left, margins.bottom + h);
	else CGContextTranslateCTM(fl_gc, margins.top, margins.right + h);
...
//
// End of "$Id: cocoaQuartzPrinter.mm 9929 2013-05-30 09:46:37Z manolo $".
//
