//
// "$Id: Scrollbar.cxx 9457 2012-05-07 23:34:19Z matt $"
//
...
void fltk3::Scrollbar::draw()
{
	...
	if (horizontal()) {
		...
		if (damage()&fltk3::DAMAGE_ALL) {
			//draw_box((pushed_==1) ? fltk3::down(slider()) : slider(), X, Y, H, H, selection_color());
...
//
// End of "$Id: Scrollbar.cxx 9457 2012-05-07 23:34:19Z matt $".
//
