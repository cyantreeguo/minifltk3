//
// "$Id: labeltype.cxx 9457 2012-05-07 23:34:19Z matt $"
//
...
void fl_normal_label(const fltk3::Label* o, int X, int Y, int W, int H, fltk3::Align align)
{
...
void fltk3::Label::measure(int& W, int& H) const
{
	...
	fltk3::LabelMeasureF* f = ::measure[labeltype()];
...
void fltk3::Widget::draw_label() const
{
	...
	if (W > 11 && align()&(fltk3::ALIGN_LEFT|fltk3::ALIGN_RIGHT)) {
		X += 3;
		W -= 6;
	}
...
//
// End of "$Id: labeltype.cxx 9457 2012-05-07 23:34:19Z matt $".
//
