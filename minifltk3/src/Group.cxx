//
// "$Id: Group.cxx 9650 2012-08-02 19:47:06Z matt $"
//
...
*/
fltk3::Group *fltk3::Group::current()
{
	return current_;
}
...
*/
void fltk3::Group::current(fltk3::Group *g)
{
	current_ = g;
}
...
*/
void fltk3::Group::add(fltk3::Widget &o)
{
	insert(o, children_);
}
...
//
// End of "$Id: Group.cxx 9650 2012-08-02 19:47:06Z matt $".
//
