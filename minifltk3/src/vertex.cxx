//
// "$Id: vertex.cxx 9615 2012-06-15 21:11:24Z matt $"
//
...
void fltk3::GraphicsDriver::begin_points()
{
	n = 0;
	what = POINT_;
}

void fltk3::GraphicsDriver::begin_line()
{
	n = 0;
	what = LINE;
}

void fltk3::GraphicsDriver::begin_loop()
{
	n = 0;
	what = LOOP;
}

void fltk3::GraphicsDriver::begin_polygon()
{
	n = 0;
	what = POLYGON;
}

double fltk3::GraphicsDriver::transform_x(double x, double y)
{
	return x*m.a + y*m.c + m.x;
}

double fltk3::GraphicsDriver::transform_y(double x, double y)
{
	return x*m.b + y*m.d + m.y;
}

double fltk3::GraphicsDriver::transform_dx(double x, double y)
{
	return x*m.a + y*m.c;
}

double fltk3::GraphicsDriver::transform_dy(double x, double y)
{
	return x*m.b + y*m.d;
}
...
#endif
//
// End of "$Id: vertex.cxx 9615 2012-06-15 21:11:24Z matt $".
//
