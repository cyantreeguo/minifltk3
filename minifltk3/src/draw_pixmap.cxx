//
// "$Id: draw_pixmap.cxx 9454 2012-05-07 12:42:32Z manolo $"
//
...
#  endif
	...
	if ( fltk3::SurfaceDevice::surface() == fltk3::DisplayDevice::display_device() ) {
		...
		fltk3::ImageRGB* rgb = new fltk3::ImageRGB((uchar*)array, d.w, d.h, 4);
...
//
// End of "$Id: draw_pixmap.cxx 9454 2012-05-07 12:42:32Z manolo $".
//
