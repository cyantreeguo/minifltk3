//
// "$Id: PagedDevice.cxx 9489 2012-05-14 14:42:16Z manolo $"
//
 ...
 */
int fltk3::PagedDevice::start_job(int pagecount, int *frompage, int *topage)
{
	return 1;
}
...
/**
 ...
 @return 0 if OK, non-zero if any error
 */
int fltk3::PagedDevice::start_page (void)
{
	return 1;
}
...
/**
 ...
 @return 0 if OK, non-zero if any error
 */
int fltk3::PagedDevice::printable_rect(int *w, int *h)
{
	return 1;
}
...
/**
 ...
 @return 0 if OK, non-zero if any error.
 */
int fltk3::PagedDevice::end_page (void)
{
	return 1;
}
...
//
// End of "$Id: PagedDevice.cxx 9489 2012-05-14 14:42:16Z manolo $".
//
