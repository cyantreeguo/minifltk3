//
// "$Id: SharedImage.cxx 9045 2011-09-17 20:42:30Z matt $"
//
...
void fltk3::SharedImage::reload() {
  ...
  if (memcmp(header, "#define", 7) == 0) // XBM file
    img = new fltk3::ImageXBM(name_);
  else if (memcmp(header, "/* XPM */", 9) == 0) // XPM file
    img = new fltk3::ImageXPM(name_);
  else {
...
/** 
 ...
 \see fltk3::ImageJPEG::ImageJPEG(const char *name, const unsigned char *data)
 \see fltk3::ImagePNG::ImagePNG (const char *name_png, const unsigned char *buffer, int maxsize)
*/
...
//
// End of "$Id: SharedImage.cxx 9045 2011-09-17 20:42:30Z matt $".
//
