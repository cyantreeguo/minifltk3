//
// "$Id: TextBuffer.cxx 10083 2014-01-25 23:47:44Z AlbrechtS $"
//
...
void fltk3::TextBuffer::add_modify_callback(fltk3::TextModifyCb bufModifiedCB,
                void *cbArg)
{
	fltk3::TextModifyCb *newModifyProcs = new fltk3::TextModifyCb[mNModifyProcs + 1];
                ...
                void *cbArg)
{
	...
	if (toRemove == -1) {
		fltk3::error("fltk3::TextBuffer::remove_modify_callback(): Can't find modify CB to remove");
		return;
	}
...
void fltk3::TextBuffer::add_predelete_callback(fltk3::TextPredeleteCb bufPreDeleteCB,
                void *cbArg)
{
	fltk3::TextPredeleteCb *newPreDeleteProcs = new fltk3::TextPredeleteCb[mNPredeleteProcs + 1];
...
void fltk3::TextBuffer::remove_predelete_callback(fltk3::TextPredeleteCb bufPreDeleteCB, void *cbArg)
{
	...
	if (toRemove == -1) {
		fltk3::error("fltk3::TextBuffer::remove_predelete_callback(): Can't find pre-delete CB to remove");
		return;
	}
	...
	fltk3::TextPredeleteCb *newPreDeleteProcs = new fltk3::TextPredeleteCb[mNPredeleteProcs];
                             ...
                             int *input_was_changed)	// returned flag: 'true' if buffer[] different from file due to utf8 encoding
{
	...
	while (q < buffer + buflen) {
		...
		//
		l = fltk3::utf8len1(*p);		// anticipate length of utf8 sequence
		...
		while ( l > 0) {
			u = fltk3::utf8decode(p, p+l, &lp);	// get single utf8 encoded char as a Unicode value
			lq = fltk3::utf8encode(u, multibyte);	// re-encode Unicode value to utf8 in multibyte[]
...
//
// End of "$Id: TextBuffer.cxx 10083 2014-01-25 23:47:44Z AlbrechtS $".
//
