//
// "$Id: draw_image.cxx 9528 2012-05-18 13:18:58Z manolo $"
//
...
#ifdef WIN32
#  include "Platform_win32_draw_image.cxx"
#elif defined(__APPLE__)
	#include "TargetConditionals.h"
    #if TARGET_IPHONE_SIMULATOR
        // iOS Simulator
		#include "Platform_ios_draw_image.cxx"
    #elif TARGET_OS_IPHONE
        // iOS device
		#include "Platform_ios_draw_image.cxx"
    #elif TARGET_OS_MAC
        // Other kinds of Mac OS
		#include "Platform_cocoa_draw_image.cxx"
    #else
...
static void color16_converter(const uchar *from, uchar *to, int w, int delta)
{
	...
	int r=ri, g=gi, b=bi;
	for (; w--; from += d, t += td) {
		r = (r&~fl_redmask)  +from[0];
		if (r>255) r = 255;
		g = (g&~fl_greenmask)+from[1];
		if (g>255) g = 255;
...
//
// End of "$Id: draw_image.cxx 9528 2012-05-18 13:18:58Z manolo $".
//
