//
// "$Id: color.cxx 9014 2011-08-26 09:39:36Z matt $"
//
...
#ifdef WIN32
#  include "Platform_win32_color.cxx"
#elif defined(__APPLE__)
	#include "TargetConditionals.h"
    #if TARGET_IPHONE_SIMULATOR
        // iOS Simulator
		#  include "Platform_ios_color.cxx"
    #elif TARGET_OS_IPHONE
        // iOS device
		#  include "Platform_ios_color.cxx"
    #elif TARGET_OS_MAC
        // Other kinds of Mac OS
		#  include "Platform_cocoa_color.cxx"
    #else
...
#    if HAVE_OVERLAY
	if (fl_overlay) colormap = fl_overlay_colormap;
	else
#    endif
		if (fl_redmask) {
#  endif
...
#    if HAVE_OVERLAY
		if (fl_overlay) numcolors = fl_overlay_visual->colormap_size;
		else
#    endif
...
*/
//
// End of "$Id: color.cxx 9014 2011-08-26 09:39:36Z matt $".
//
