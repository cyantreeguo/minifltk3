//
// "$Id: Roller.cxx 9457 2012-05-07 23:34:19Z matt $"
//
	...
	if (horizontal()) { // horizontal one
		...
		if (active_r()) {
			...
			for (double yy = -ARC+modf(offset*sin(ARC)/(W/2)/delta,&junk)*delta;;
				...
				fltk3::yxline(X+yy1,Y+1,Y+H-1);
				if (yy < 0) yy1--;
				else yy1++;
				fltk3::color(fltk3::LIGHT1);
				fltk3::yxline(X+yy1,Y+1,Y+H-1);
			}
			// draw edges:
...
//
// End of "$Id: Roller.cxx 9457 2012-05-07 23:34:19Z matt $".
//
