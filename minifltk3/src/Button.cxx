//
// "$Id: Button.cxx 9638 2012-07-24 04:41:38Z matt $"
//
...
{
	Box *b = value() ? ( down_box() ? down_box() : box()->downbox() ) : box();
...
void fltk3::Button::draw(Box* b, int x, int y, int w, int h, Color c, Box::Flags f)
{
	...
	fltk3::Color col;
	if (value()) {
		//if (selection_color()==fltk3::GRAY) col = fltk3::color_average(fltk3::BLACK, c, 0.2f);
...
//
// End of "$Id: Button.cxx 9638 2012-07-24 04:41:38Z matt $".
//
