//
// "$Id: win32_font.cxx 9456 2012-05-07 14:37:36Z manolo $"
//
...
double fltk3::GDIGraphicsDriver::width(unsigned int c)
{
	...
	if (!fontsize->width[r]) {
		...
		for (int k=0; k<0x0400; k++) fontsize->width[r][k] = -1; // -1-not cache
	} else {
		if ( fontsize->width[r][c&0x03FF] >= 0 ) { // >=0-cached already
...
//
// End of "$Id: win32_font.cxx 9456 2012-05-07 14:37:36Z manolo $".
//
