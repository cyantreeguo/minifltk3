/*
 * "$Id: utf.cxx 9640 2012-07-24 19:50:22Z matt $"
 *
	...
	if (dstlen) {
		for (;;) {
			...
			if (!(*p & 0x80)) { /* ascii */
				...
				int len;
				unsigned ucs = fltk3::utf8decode(p,e,&len);
				p += len;
				if (ucs < 0x10000) {
					dst[count] = ucs;
				} else {
...
/*
 * End of "$Id: utf.cxx 9640 2012-07-24 19:50:22Z matt $".
 */
