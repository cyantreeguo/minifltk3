//
// "$Id: read_image.cxx 9011 2011-08-25 21:50:59Z matt $"
//
...
#ifdef WIN32
#  include "Platform_win32_read_image.cxx"
#elif defined(__APPLE__)
	#include "TargetConditionals.h"
    #if TARGET_IPHONE_SIMULATOR
        // iOS Simulator
		#include "Platform_ios_read_image.cxx"
    #elif TARGET_OS_IPHONE
        // iOS device
		#include "Platform_ios_read_image.cxx"
    #elif TARGET_OS_MAC
        // Other kinds of Mac OS
		#include "Platform_cocoa_read_image.cxx"
    #else
...
//
// End of "$Id: read_image.cxx 9011 2011-08-25 21:50:59Z matt $".
//
