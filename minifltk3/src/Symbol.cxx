//
// "$Id: Symbol.cxx 9525 2012-05-17 23:39:28Z ianmacarthur $"
//
...
static unsigned hashindex(const char *name, unsigned n, bool delok)
{
	...
	unsigned pos = 0;
	unsigned i;
	for (i = 0; i < n; i++) pos = 37*pos + name[i];
	pos %= hashtablesize;
...
static void double_hashtable()
{
	...
	for (int i = 3; i*i <= n; i += 2) while (n%i == 0) {
			i = 3;
			n += 2;
		}
 ...
 */
bool Symbol::fills_rectangle() const
{
	return false;
}
...
//
// End of "$Id: Symbol.cxx 9525 2012-05-17 23:39:28Z ianmacarthur $".
//
