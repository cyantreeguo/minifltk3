//
// "$Id: fltk3::TextEditor.cxx 10031 2013-12-13 16:28:38Z manolo $"
//
...
fltk3::TextEditor::TextEditor(int X, int Y, int W, int H,  const char* l) : fltk3::TextDisplay(X, Y, W, H, l)
{
	mCursorOn = 1;
	insert_mode_ = 1;
	key_bindings = 0;
...
static struct {
	...
	{ fltk3::EscapeKey,    (int)(fltk3::TEXT_EDITOR_ANY_STATE), fltk3::TextEditor::kf_ignore     },
	{ fltk3::EnterKey,     (int)(fltk3::TEXT_EDITOR_ANY_STATE), fltk3::TextEditor::kf_enter      },
	{ fltk3::KPEnterKey,  (int)(fltk3::TEXT_EDITOR_ANY_STATE), fltk3::TextEditor::kf_enter      },
	{ fltk3::BackSpaceKey, (int)(fltk3::TEXT_EDITOR_ANY_STATE), fltk3::TextEditor::kf_backspace  },
	{ fltk3::InsertKey,    (int)(fltk3::TEXT_EDITOR_ANY_STATE), fltk3::TextEditor::kf_insert     },
	{ fltk3::DeleteKey,    (int)(fltk3::TEXT_EDITOR_ANY_STATE), fltk3::TextEditor::kf_delete     },
...
void fltk3::TextEditor::add_key_binding(int key, int state, KeyFunc function, KeyBinding** list)
{
...
//extern void fltk3::text_drag_me(int pos, fltk3::Text_Display* d);
namespace fltk3
{
...
//
// End of "$Id: fltk3::TextEditor.cxx 10031 2013-12-13 16:28:38Z manolo $".
//
