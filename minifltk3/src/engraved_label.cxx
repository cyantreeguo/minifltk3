//
// "$Id: engraved_label.cxx 9017 2011-08-27 22:50:53Z matt $"
//
...
static void innards(const fltk3::Label* o, int X, int Y, int W, int H, fltk3::Align align, int data[][3], int n)
{
	fltk3::Align a1 = align;
	if (a1 & fltk3::ALIGN_CLIP) {
		fltk3::push_clip(X, Y, W, H);
		a1 = (fltk3::Align)(a1&~fltk3::ALIGN_CLIP);
	}
...
//
// End of "$Id: engraved_label.cxx 9017 2011-08-27 22:50:53Z matt $".
//
