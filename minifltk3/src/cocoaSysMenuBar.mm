//
// "$Id: cocoaSysMenuBar.mm 9890 2013-04-17 16:37:24Z manolo $"
//
...
static void setMenuShortcut(NSMenu *mh, int miCnt, const fltk3::MenuItem *m) {
	...
	if (m->flags & fltk3::SUBMENU) return;
	if (m->flags & fltk3::SUBMENU_POINTER) return;
...
//
// End of "$Id: cocoaSysMenuBar.mm 9890 2013-04-17 16:37:24Z manolo $".
//
