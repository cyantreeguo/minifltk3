//
// "$Id: xft_set_fonts.cxx 9109 2011-10-01 15:43:32Z matt $"
//
...
static void make_raw_name(char *raw, char *pretty)
{
	...
	raw[0] = ' ';
	raw[1] = 0; // Default start of "raw name" text
...
int fltk3::get_font_sizes(fltk3::Font fnum, int*& sizep)
{
	...
	array[0] = 0;
	int j = 1; // claim all fonts are scalable
...
//
// End of "$Id: xft_set_fonts.cxx 9109 2011-10-01 15:43:32Z matt $".
//
