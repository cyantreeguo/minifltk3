//
// "$Id: InputChoice.h 9638 2012-07-24 04:41:38Z matt $"
//
...
class FLTK3_EXPORT InputChoice : public fltk3::Group
{
	...
	inline int inp_x() {
		return(fltk3::box_dx(box()));
	}
	inline int inp_y() {
		return(fltk3::box_dy(box()));
	}
	inline int inp_w() {
		return(w() - fltk3::box_dw(box()) - 20);
	}
	inline int inp_h() {
		return(h() - fltk3::box_dh(box()));
	}

	inline int menu_x() {
		return(w() - 20 - fltk3::box_dx(box()));
	}
	inline int menu_y() {
		return(fltk3::box_dy(box()));
	}
...
public:
	...
	int changed() const {
		return inp_->changed() | Widget::changed();
	}
	void clear_changed() {
		inp_->clear_changed();
...
//
// End of "$Id: InputChoice.h 9638 2012-07-24 04:41:38Z matt $".
//
