//
// "$Id: FileInput.h 9560 2012-05-30 21:04:33Z matt $"
//
...
public:
	 ...
	 */
	fltk3::Color	errorcolor() const {
		return errorcolor_;
	}
	/** Sets the current error color to \p c */
	void		errorcolor(fltk3::Color c) {
		errorcolor_ = c;
	}
...
//
// End of "$Id: FileInput.h 9560 2012-05-30 21:04:33Z matt $".
//
