//
// "$Id: Browser_.h 9651 2012-08-03 11:29:01Z matt $"
//
...
#include "Group.h"
#include "Scrollbar.h"
#include "run.h"		// fltk3::scrollbar_size()
...
public:
	...
	void scrollbar_right() {
		scrollbar.align(fltk3::ALIGN_RIGHT);
	}
	 ...
	 */
	void scrollbar_left() {
		scrollbar.align(fltk3::ALIGN_LEFT);
	}
...
//
// End of "$Id: Browser_.h 9651 2012-08-03 11:29:01Z matt $".
//
