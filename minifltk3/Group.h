//
// "$Id: Group.h 9557 2012-05-29 21:17:12Z matt $"
//
...
public:
	 ...
	 */
	int find(const fltk3::Widget& o) const {
		return find(&o);
	}
	 ...
	 */
	void insert(fltk3::Widget& o, fltk3::Widget* before) {
	...
	/**
	 See void fltk3::Group::resizable(fltk3::Widget *box)
	 */
	fltk3::Widget* resizable() const {
		return resizable_;
	}
	/**
	 Adds a widget to the group and makes it the resizable widget.
	 */
	void add_resizable(fltk3::Widget& o) {
		resizable_ = &o;
		add(o);
	}
	void init_sizes();
	 ...
	 */
	void focus(fltk3::Widget* W) {
		W->take_focus();
	}

	/** This is for forms compatibility only */
	fltk3::Widget* & _ddfdesign_kludge() {
		return resizable_;
	}
...
//
// End of "$Id: Group.h 9557 2012-05-29 21:17:12Z matt $".
//
