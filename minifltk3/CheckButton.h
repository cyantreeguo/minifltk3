//
// "$Id: CheckButton.h 9436 2012-05-02 21:24:21Z matt $"
//
...
{
public:
	CheckButton(int X, int Y, int W, int H, const char *L = 0): fltk3::LightButton(X, Y, W, H, L) {
		box(fltk3::NO_BOX);
...
//
// End of "$Id: CheckButton.h 9436 2012-05-02 21:24:21Z matt $".
//
