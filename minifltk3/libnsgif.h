...
typedef struct gif_frame {
  	unsigned char/*bool*/ display;				/**< whether the frame should be displayed/animated */
	...
	*/
  	...
  	unsigned char/*bool*/ virgin;				/**< whether the frame has previously been used */
	unsigned char/*bool*/ opaque;				/**< whether the frame is totally opaque */
	unsigned char/*bool*/ redraw_required;			/**< whether a forcable screen redraw is required */
	unsigned char disposal_method;		/**< how the previous frame should be disposed; affects plotting */
	unsigned char/*bool*/ transparency;	 		/**< whether we acknoledge transparency */
...
typedef void (*gif_bitmap_cb_set_opaque)(void *bitmap, unsigned char/*bool*/ opaque);
typedef unsigned char/*bool*/ (*gif_bitmap_cb_test_opaque)(void *bitmap);
...
typedef struct gif_animation {
	...
	*/
	...
	unsigned char/*bool*/ global_colours;				/**< whether the GIF has a global colour table */
	unsigned int *global_colour_table;		/**< global colour table */
	unsigned int *local_colour_table;		/**< local colour table */
} gif_animation;

void gif_create(gif_animation *gif, gif_bitmap_callback_vt *bitmap_callbacks);
gif_result gif_initialise(gif_animation *gif, int size, unsigned char *data);
