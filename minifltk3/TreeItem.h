//
// "$Id: TreeItem.h 9300 2012-03-23 20:36:00Z ianmacarthur $"
//
...
public:
	...
	TreeItem(fltk3::Tree *tree);			// CTOR -- ABI 1.3.3+
	virtual ~TreeItem();			// DTOR -- ABI 1.3.3+
#else
	~TreeItem();				// DTOR -- backwards compatible
#endif
...
//
// End of "$Id: TreeItem.h 9300 2012-03-23 20:36:00Z ianmacarthur $".
//
