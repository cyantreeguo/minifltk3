//
// "$Id: Window.h 9302 2012-03-26 10:20:53Z ianmacarthur $"
//
...
public:
	...
	/** See void fltk3::Window::hotspot(int x, int y, int offscreen = 0) */
	void hotspot(const fltk3::Widget& p, int offscreen = 0) {
		hotspot(&p,offscreen);
	}
...
//
// End of "$Id: Window.h 9302 2012-03-26 10:20:53Z ianmacarthur $".
//
