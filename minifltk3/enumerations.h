//
// "$Id: enumerations.h 9780 2012-12-26 19:58:31Z manolo $"
//
...
const unsigned int KanaKey    = 0xff2e;       ///< The Kana key of JIS keyboards.
const unsigned int EisuKey    = 0xff2f;       ///< The Eisu key of JIS keyboards.
const unsigned int YenKey     = 0xff30;       ///< The Yen key of JIS keyboards.
const unsigned int JISUnderscoreKey = 0xff31; ///< The underscore key of JIS keyboards.
...
const unsigned int KPKey	= 0xff80;	///< One of the keypad numbers; use fltk3::KPKey + 'n' for digit n.
...
inline unsigned int BUTTON(unsigned int n)
{
	return (0x00800000<<(n));        ///< Mouse button n (n > 0) is pushed
}
...
extern FLTK3_EXPORT Box* NO_BOX;
extern FLTK3_EXPORT Box* FLAT_BOX;
extern FLTK3_EXPORT Box* UP_BOX;
extern FLTK3_EXPORT Box* DOWN_BOX;
extern FLTK3_EXPORT Box* THIN_UP_BOX;
extern FLTK3_EXPORT Box* THIN_DOWN_BOX;
extern FLTK3_EXPORT Box* ROUND_UP_BOX;
extern FLTK3_EXPORT Box* ROUND_DOWN_BOX;
extern FLTK3_EXPORT Box* ENGRAVED_BOX;
extern FLTK3_EXPORT Box* FRAME_BOX;
extern FLTK3_EXPORT Box* EMBOSSED_BOX;
extern FLTK3_EXPORT Box* BORDER_BOX;
extern FLTK3_EXPORT Box* SHADOW_BOX;
extern FLTK3_EXPORT Box* ROUNDED_BOX;
extern FLTK3_EXPORT Box* RSHADOW_BOX;
extern FLTK3_EXPORT Box* RFLAT_BOX;
extern FLTK3_EXPORT Box* DIAMOND_UP_BOX;
extern FLTK3_EXPORT Box* DIAMOND_DOWN_BOX;
extern FLTK3_EXPORT Box* OVAL_BOX;
extern FLTK3_EXPORT Box* OSHADOW_BOX;
extern FLTK3_EXPORT Box* OFLAT_BOX;

extern FLTK3_EXPORT Box* UP_FRAME;
extern FLTK3_EXPORT Box* DOWN_FRAME;
extern FLTK3_EXPORT Box* THIN_UP_FRAME;
extern FLTK3_EXPORT Box* THIN_DOWN_FRAME;
extern FLTK3_EXPORT Box* ENGRAVED_FRAME;
extern FLTK3_EXPORT Box* EMBOSSED_FRAME;
extern FLTK3_EXPORT Box* BORDER_FRAME;
extern FLTK3_EXPORT Box* SHADOW_FRAME;
extern FLTK3_EXPORT Box* ROUNDED_FRAME;
extern FLTK3_EXPORT Box* OVAL_FRAME;

// GTK+
extern FLTK3_EXPORT Box* GTK_UP_BOX;
extern FLTK3_EXPORT Box* GTK_DOWN_BOX;
extern FLTK3_EXPORT Box* GTK_THIN_UP_BOX;
extern FLTK3_EXPORT Box* GTK_THIN_DOWN_BOX;
extern FLTK3_EXPORT Box* GTK_ROUND_UP_BOX;
extern FLTK3_EXPORT Box* GTK_ROUND_DOWN_BOX;
extern FLTK3_EXPORT Box* GTK_UP_FRAME;
extern FLTK3_EXPORT Box* GTK_DOWN_FRAME;
extern FLTK3_EXPORT Box* GTK_THIN_UP_FRAME;
extern FLTK3_EXPORT Box* GTK_THIN_DOWN_FRAME;

// PLASTIC
extern FLTK3_EXPORT Box* PLASTIC_UP_BOX;
extern FLTK3_EXPORT Box* PLASTIC_DOWN_BOX;
extern FLTK3_EXPORT Box* PLASTIC_THIN_UP_BOX;
extern FLTK3_EXPORT Box* PLASTIC_THIN_DOWN_BOX;
extern FLTK3_EXPORT Box* PLASTIC_ROUND_UP_BOX;
extern FLTK3_EXPORT Box* PLASTIC_ROUND_DOWN_BOX;
extern FLTK3_EXPORT Box* PLASTIC_UP_FRAME;
extern FLTK3_EXPORT Box* PLASTIC_DOWN_FRAME;

// GLEAM
extern FLTK3_EXPORT Box* GLEAM_UP_BOX;
extern FLTK3_EXPORT Box* GLEAM_DOWN_BOX;
extern FLTK3_EXPORT Box* GLEAM_THIN_UP_BOX;
extern FLTK3_EXPORT Box* GLEAM_THIN_DOWN_BOX;
extern FLTK3_EXPORT Box* GLEAM_ROUND_UP_BOX;
extern FLTK3_EXPORT Box* GLEAM_ROUND_DOWN_BOX;
extern FLTK3_EXPORT Box* GLEAM_UP_FRAME;
extern FLTK3_EXPORT Box* GLEAM_DOWN_FRAME;

// METRO
extern FLTK3_EXPORT Box* METRO_UP_BOX;
extern FLTK3_EXPORT Box* METRO_DOWN_BOX;
extern FLTK3_EXPORT Box* METRO_THIN_UP_BOX;
extern FLTK3_EXPORT Box* METRO_THIN_DOWN_BOX;
extern FLTK3_EXPORT Box* METRO_ROUND_UP_BOX;
extern FLTK3_EXPORT Box* METRO_ROUND_DOWN_BOX;
extern FLTK3_EXPORT Box* METRO_UP_FRAME;
extern FLTK3_EXPORT Box* METRO_DOWN_FRAME;
...
const Color NUM_FREE_COLOR = 16;
const Color GRAY_RAMP      = 32;
const Color NUM_GRAY       = 24;
const Color GRAY           = BACKGROUND_COLOR;
const Color COLOR_CUBE     = 56;
const Color NUM_RED        = 5;
const Color NUM_GREEN      = 8;
const Color NUM_BLUE       = 5;
...
inline Color lighter(Color c)
{
	return color_average(c, WHITE, .67f);
}

/** Returns a darker version of the specified color. */
inline Color darker(Color c)
{
	return color_average(c, BLACK, .67f);
}
...
/** Returns a gray color value from black (i == 0) to white (i == fltk3::NUM_GRAY - 1).
 ...
 \endcode
 */
inline Color gray_ramp(int i)
{
	return (Color)(i+GRAY_RAMP);
}
...
//
// End of "$Id: enumerations.h 9780 2012-12-26 19:58:31Z manolo $".
//
