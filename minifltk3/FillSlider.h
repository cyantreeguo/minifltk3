//
// "$Id: FillSlider.h 9638 2012-07-24 04:41:38Z matt $"
//
...
public:
	...
	FillSlider(int x,int y,int w,int h,const char *l=0) : fltk3::Slider(x,y,w,h,l)
	{
...
//
// End of "$Id: FillSlider.h 9638 2012-07-24 04:41:38Z matt $".
//
