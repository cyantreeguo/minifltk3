//
// "$Id: Menu_.h 9560 2012-05-30 21:04:33Z matt $"
//
...
public:
	 ...
	 */
	const fltk3::MenuItem* test_shortcut() {
	 ...
	 */
	const fltk3::MenuItem *menu() const {
		return menu_;
	}
	...
	void shortcut(int i, unsigned int s) {
		menu_[i].shortcut(s);
	}
	...
	const fltk3::MenuItem *mvalue() const {
		return value_;
	}
...
//
// End of "$Id: Menu_.h 9560 2012-05-30 21:04:33Z matt $".
//
