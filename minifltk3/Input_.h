//
// "$Id: Input_.h 9300 2012-03-23 20:36:00Z ianmacarthur $"
//
...
public:
	 ...
	 */
	void wrap(int b) {
		if (b) type((uchar)(type() | fltk3::INPUT_WRAP));
...
//
// End of "$Id: Input_.h 9300 2012-03-23 20:36:00Z ianmacarthur $".
//
