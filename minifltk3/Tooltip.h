//
// "$Id: Tooltip.h 9300 2012-03-23 20:36:00Z ianmacarthur $"
//
...
public:
	...
	static int enabled() {
		return fltk3::option(fltk3::OPTION_SHOW_TOOLTIPS);
	}
	/**    Enables tooltips on all widgets (or disables if <i>b</i> is false).  */
	static void enable(int b = 1) {
		fltk3::option(fltk3::OPTION_SHOW_TOOLTIPS, (b!=0));
	}
...
//
// End of "$Id: Tooltip.h 9300 2012-03-23 20:36:00Z ianmacarthur $".
//
