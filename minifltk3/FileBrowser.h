//
// "$Id: FileBrowser.h 9300 2012-03-23 20:36:00Z ianmacarthur $"
//
...
public:
	...
	fltk3::Fontsize  textsize() const {
		return Browser::textsize();
	};
	void		textsize(fltk3::Fontsize s) {
		Browser::textsize(s);
		iconsize_ = (uchar)(3 * s / 2);
	};
...
//
// End of "$Id: FileBrowser.h 9300 2012-03-23 20:36:00Z ianmacarthur $".
//
