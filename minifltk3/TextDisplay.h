//
// "$Id: TextDisplay.h 9300 2012-03-23 20:36:00Z ianmacarthur $"
//
...
public:
	...
	/**
	 ...
	 \return cursor color
	 */
	fltk3::Color cursor_color() const {
	 ...
	 */
	void cursor_color(fltk3::Color n) {
		mCursor_color = n;
	}
	 ...
	 */
	fltk3::Align scrollbar_align() const {
	 ...
	 */
	void scrollbar_align(fltk3::Align a) {
		scrollbar_align_ = a;
	}
	...
	void linenumber_font(fltk3::Font val);
	fltk3::Font linenumber_font() const;
	void linenumber_size(fltk3::Fontsize val);
	fltk3::Fontsize linenumber_size() const;
	void linenumber_fgcolor(fltk3::Color val);
	fltk3::Color linenumber_fgcolor() const;
	void linenumber_bgcolor(fltk3::Color val);
	fltk3::Color linenumber_bgcolor() const;
	void linenumber_align(fltk3::Align val);
	fltk3::Align linenumber_align() const;
...
protected:
	...
	fltk3::Font     linenumber_font_;
	fltk3::Fontsize linenumber_size_;
	fltk3::Color    linenumber_fgcolor_;
	fltk3::Color    linenumber_bgcolor_;
	fltk3::Align    linenumber_align_;
...
//
// End of "$Id: TextDisplay.h 9300 2012-03-23 20:36:00Z ianmacarthur $".
//
