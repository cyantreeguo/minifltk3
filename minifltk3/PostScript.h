//
// "$Id: PostScript.h 9694 2012-10-01 16:16:03Z manolo $"
//
...
public:
	...
	void draw(fltk3::ImageRGB * rgb,int XP, int YP, int WP, int HP, int cx, int cy);
...
public:
	...
	~PostScriptFileDevice();
	int start_job(int pagecount, int*, int*) {
		return start_job(pagecount);
	}
...
//
// End of "$Id: PostScript.h 9694 2012-10-01 16:16:03Z manolo $"
//
