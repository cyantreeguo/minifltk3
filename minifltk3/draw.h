//
// "$Id: draw.h 9638 2012-07-24 04:41:38Z matt $"
//
...
#include "x.h"	      // for fltk3::Region
#include "enumerations.h"  // for the color names
#include "Window.h"     // for fltk3::set_spot()
#include "Device.h"     // for fltk3::graphics_driver
#include "Box.h"     // for fltk3::Box::Flags
...
/**
 ...
 \param[in] c color
 */
inline void color(fltk3::Color c)
{
	fltk3::graphics_driver->color(c);        // select indexed color
}
 ...
 */
inline void color(uchar r, uchar g, uchar b)
{
	fltk3::graphics_driver->color(r,g,b);        // select actual color
}
/**
 Returns the last fltk3::color() that was set.
 This can be used for state save/restore.
 */
inline fltk3::Color color()
{
	return fltk3::graphics_driver->color();
}
/** @} */
 ...
 */
inline void push_no_clip()
{
	fltk3::graphics_driver->push_no_clip();
}
...
{
	fltk3::graphics_driver->pop_clip();
}
 ...
 */
inline int not_clipped(int x, int y, int w, int h)
{
	return fltk3::graphics_driver->not_clipped(x,y,w,h);
}
/**
...
inline void restore_clip()
{
	fltk3::graphics_driver->restore_clip();
}
/**
 ...
 */
inline void clip_region(fltk3::Region r)
{
	fltk3::graphics_driver->clip_region(r);
}
/**
 Returns the current clipping region.
 */
inline fltk3::Region clip_region()
{
	return fltk3::graphics_driver->clip_region();
}
...
{
	fltk3::graphics_driver->point(x,y);
}
 ...
 */
inline void line_style(int style, int width=0, char* dashes=0)
{
	fltk3::graphics_driver->line_style(style,width,dashes);
}
enum {
 ...
 */
inline void line(int x, int y, int x1, int y1)
{
	fltk3::graphics_driver->line(x,y,x1,y1);
}
/**
 Draws a line from (x,y) to (x1,y1) and another from (x1,y1) to (x2,y2)
 */
inline void line(int x, int y, int x1, int y1, int x2, int y2)
{
	fltk3::graphics_driver->line(x,y,x1,y1,x2,y2);
}
 ...
 */
inline void loop(int x, int y, int x1, int y1, int x2, int y2)
{
	fltk3::graphics_driver->loop(x,y,x1,y1,x2,y2);
}
/**
 ...
 */
inline void polygon(int x, int y, int x1, int y1, int x2, int y2)
{
	fltk3::graphics_driver->polygon(x,y,x1,y1,x2,y2);
}
/**
 ...
 */
inline void xyline(int x, int y, int x1)
{
	fltk3::graphics_driver->xyline(x,y,x1);
}
/**
 Draws a horizontal line from (x,y) to (x1,y), then vertical from (x1,y) to (x1,y2)
 */
inline void xyline(int x, int y, int x1, int y2)
{
	fltk3::graphics_driver->xyline(x,y,x1,y2);
}
/**
 ...
 */
inline void xyline(int x, int y, int x1, int y2, int x3)
{
	fltk3::graphics_driver->xyline(x,y,x1,y2,x3);
}
 ...
 */
inline void yxline(int x, int y, int y1)
{
	fltk3::graphics_driver->yxline(x,y,y1);
}
/**
 Draws a vertical line from (x,y) to (x,y1), then a horizontal from (x,y1) to (x2,y1)
 */
inline void yxline(int x, int y, int y1, int x2)
{
	fltk3::graphics_driver->yxline(x,y,y1,x2);
}
/**
 Draws a vertical line from (x,y) to (x,y1) then a horizontal from (x,y1)
 to (x2,y1), then another vertical from (x2,y1) to (x2,y3)
 */
inline void yxline(int x, int y, int y1, int x2, int y3)
{
	fltk3::graphics_driver->yxline(x,y,y1,x2,y3);
}
 ...
 */
inline void arc(int x, int y, int w, int h, double a1, double a2)
{
	fltk3::graphics_driver->arc(x,y,w,h,a1,a2);
}
/**
 ...
 than or equal to \p a1.
 */
inline void pie(int x, int y, int w, int h, double a1, double a2)
{
	fltk3::graphics_driver->pie(x,y,w,h,a1,a2);
}
...
inline void push_origin()
{
	fltk3::graphics_driver->push_origin();
}
inline void pop_origin()
{
	fltk3::graphics_driver->pop_origin();
}
inline void translate_origin(int dx, int dy)
{
	fltk3::graphics_driver->translate_origin(dx, dy);
}
inline void origin(int x, int y)
{
	fltk3::graphics_driver->origin(x, y);
}
inline int origin_x()
{
	return fltk3::graphics_driver->origin_x();
}
inline int origin_y()
{
	return fltk3::graphics_driver->origin_y();
}
...
{
	fltk3::graphics_driver->push_matrix();
}
/**
...
{
	fltk3::graphics_driver->pop_matrix();
}
/**
...
{
	fltk3::graphics_driver->scale(x, y);
}
/**
 Concatenates scaling transformation onto the current one.
...
{
	fltk3::graphics_driver->scale(x, x);
}
/**
...
{
	fltk3::graphics_driver->translate(x, y);
}
/**
 Concatenates rotation transformation onto the current one.
 \param[in] d - rotation angle, counter-clockwise in degrees (not radians)
 */
inline void rotate(double d)
{
	fltk3::graphics_driver->rotate(d);
}
/**
 ...
 */
inline void begin_points()
{
	fltk3::graphics_driver->begin_points();
}
/**
...
{
	fltk3::graphics_driver->begin_line();
}
/**
 Starts drawing a closed sequence of lines.
 */
inline void begin_loop()
{
	fltk3::graphics_driver->begin_loop();
}

/**
 Starts drawing a convex filled polygon.
 */
inline void begin_polygon()
{
	fltk3::graphics_driver->begin_polygon();
}
/**
...
{
	fltk3::graphics_driver->vertex(x,y);
}
/**
 ...
 */
inline void arc(double x, double y, double r, double start, double end)
{
	fltk3::graphics_driver->arc(x,y,r,start,end);
}
/**
...
{
	fltk3::graphics_driver->circle(x,y,r);
}
/**
 Ends list of points, and draws.
 */
inline void end_points()
{
	fltk3::graphics_driver->end_points();
}
/**
...
{
	fltk3::graphics_driver->end_line();
}
/**
 Ends closed sequence of lines, and draws.
 */
inline void end_loop()
{
	fltk3::graphics_driver->end_loop();
}
/**
...
{
	fltk3::graphics_driver->end_polygon();
}
/**
 ...
 */
inline void begin_complex_polygon()
{
	fltk3::graphics_driver->begin_complex_polygon();
}
...
inline void gap()
{
	fltk3::graphics_driver->gap();
}
/**
 Ends complex filled polygon, and draws.
 */
inline void end_complex_polygon()
{
	fltk3::graphics_driver->end_complex_polygon();
}
...
/**
 ...
 \param[in] x,y coordinate
 */
inline double transform_x(double x, double y)
{
	return fltk3::graphics_driver->transform_x(x, y);
}
/**
 Transforms coordinate using the current transformation matrix.
 \param[in] x,y coordinate
 */
inline double transform_y(double x, double y)
{
	return fltk3::graphics_driver->transform_y(x, y);
}
/**
 Transforms distance using current transformation matrix.
 \param[in] x,y coordinate
 */
inline double transform_dx(double x, double y)
{
	return fltk3::graphics_driver->transform_dx(x, y);
}
/**
 Transforms distance using current transformation matrix.
 \param[in] x,y coordinate
 */
inline double transform_dy(double x, double y)
{
	return fltk3::graphics_driver->transform_dy(x, y);
}
/**
 Adds coordinate pair to the vertex list without further transformations.
 \param[in] xf,yf transformed coordinate
 */
inline void transformed_vertex(double xf, double yf)
{
	fltk3::graphics_driver->transformed_vertex(xf,yf);
}
/** @} */
 ...
 */
inline void font(fltk3::Font face, fltk3::Fontsize size)
{
	fltk3::graphics_driver->font(face,size);
}
 ...
 */
inline fltk3::Font font()
{
	return fltk3::graphics_driver->font();
}
/**
 Returns the \p size set by the most recent call to fltk3::font().
 This can be used to save/restore the font.
 */
inline fltk3::Fontsize size()
{
	return fltk3::graphics_driver->size();
}
...
inline int height()
{
	return fltk3::graphics_driver->height();
}
...
inline int  descent()
{
	return fltk3::graphics_driver->descent();
}
...
inline double width(const char* txt, int n)
{
	return fltk3::graphics_driver->width(txt, n);
}
...
inline double width(unsigned int c)
{
	return fltk3::graphics_driver->width(c);
}
 ...
 */
inline void draw(const char* str, int n, int x, int y)
{
	fltk3::graphics_driver->draw(str,n,x,y);
}
/**
 Draws at the given \p x, \p y location a UTF-8 string of length \p n bytes
 rotating \p angle degrees counter-clockwise.
 */
inline void draw(int angle, const char* str, int n, int x, int y)
{
	fltk3::graphics_driver->draw(angle,str,n,x,y);
}

/**
 Draws a UTF-8 string of length \p n bytes right to left starting at the given \p x, \p y location.
 */
inline void rtl_draw(const char* str, int n, int x, int y)
{
	fltk3::graphics_driver->rtl_draw(str,n,x,y);
}
FLTK3_EXPORT void measure(const char* str, int& x, int& y,
                          int draw_symbols = 1);
FLTK3_EXPORT void draw(const char* str, int x, int y, int w, int h, fltk3::Align align, fltk3::Image* img=0, int draw_symbols = 1);
FLTK3_EXPORT void draw(const char* str, int x, int y, int w, int h, fltk3::Align align, void (*callthis)(const char *,int,int,int),
...
// other:
FLTK3_EXPORT void scroll(int X, int Y, int W, int H, int dx, int dy, void (*draw_area)(void*, int,int,int,int), void* data);
...
//
// End of "$Id: draw.h 9638 2012-07-24 04:41:38Z matt $".
//
