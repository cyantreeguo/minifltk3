//
// "$Id: x.h 9301 2012-03-25 17:33:46Z manolo $"
//
...
public:
	...
	static Fl_X* first;
	static Fl_X* i(const fltk3::Window* wi) {
		return wi->i;
	}
	...
	static void x(fltk3::Window* wi, int X) {
		wi->x(X);
	}
	static void y(fltk3::Window* wi, int Y) {
		wi->y(Y);
	}
...
//
// End of "$Id: x.h 9301 2012-03-25 17:33:46Z manolo $".
//
