...
public:
	...
	virtual void draw(const char *str, int n, float x, float y) {
		draw(str, n, (int)(x+0.5), (int)(y+0.5));
	}
#endif
	...
	// Image classes
	/** \brief Draws an fltk3::ImageRGB object to the device.
	 *
	 Specifies a bounding box for the image, with the origin (upper left-hand corner) of
	 the image offset by the cx and cy arguments.
	 */
	virtual   void draw(fltk3::ImageRGB * rgb,int XP, int YP, int WP, int HP, int cx, int cy) {}
	...
	virtual inline double width(unsigned int c) {
		char ch = (char)c;
		return width(&ch, 1);
	}
	...
	inline Fl_Font_Descriptor *font_descriptor() {
		return font_descriptor_;
	}
	/** Sets the current Fl_Font_Descriptor for the graphics driver */
	inline void font_descriptor(Fl_Font_Descriptor *d) {
		font_descriptor_ = d;
	}
...
public:
	...
	void draw(fltk3::ImageRGB *img, int XP, int YP, int WP, int HP, int cx, int cy);
...
protected:
	...
	SurfaceDevice(fltk3::GraphicsDriver *graphics_driver) {
		_driver = graphics_driver;
	};
public:
	virtual void set_current(void);
	/** \brief Sets the graphics driver of this drawing surface. */
	inline void driver(fltk3::GraphicsDriver *graphics_driver) {
		_driver = graphics_driver;
	};
	/** \brief Returns the graphics driver of this drawing surface. */
	inline fltk3::GraphicsDriver *driver() {
		return _driver;
	};
	/** \brief the surface that currently receives graphics output */
	static inline fltk3::SurfaceDevice *surface() {
		return _surface;
	};
	/** \brief The destructor. */
...
public:
	...
	static inline DisplayDevice *display_device() {
		return _display;
	};
};
