//
// "$Id: win32.h 9300 2012-03-23 20:36:00Z ianmacarthur $"
//
...
#ifndef Fltk3_X_H
#  error "Never use <win32.h> directly; include <x.h> instead."
#endif // !Fltk3_X_H
...
public:
	...
	void setwindow(fltk3::Window* wi) {
		w=wi;
		wi->i=this;
	}
	void flush() {
...
#endif // FLTK3_DOXYGEN
//
// End of "$Id: win32.h 9300 2012-03-23 20:36:00Z ianmacarthur $".
//
