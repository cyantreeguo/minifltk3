//
// "$Id: HelpView.h 9300 2012-03-23 20:36:00Z ianmacarthur $"
//
...
struct FLTK3_EXPORT HelpFontStyle {
	...
	void get(fltk3::Font &afont, fltk3::Fontsize &asize, fltk3::Color &acolor) {
		afont=f;        ///< Gets current font attributes
		asize=s;
		acolor=c;
	}
	void set(fltk3::Font afont, fltk3::Fontsize asize, fltk3::Color acolor) {
		f=afont;        ///< Sets current font attributes
		s=asize;
		c=acolor;
	}
	HelpFontStyle(fltk3::Font afont, fltk3::Fontsize asize, fltk3::Color acolor) {
...
struct FLTK3_EXPORT HelpFontStack {
	...
	void top(fltk3::Font &f, fltk3::Fontsize &s, fltk3::Color &c) {
	...
	size_t count() const {
		return nfonts_;       // Gets the current number of fonts in the stack
	}
...
protected:
	...
	void initfont(fltk3::Font &f, fltk3::Fontsize &s, fltk3::Color &c) {
		f = textfont_;
		s = textsize_;
		c = textcolor_;
		fstack_.init(f, s, c);
	}
	void pushfont(fltk3::Font f, fltk3::Fontsize s) {
		fstack_.push(f, s, textcolor_);
	}
	void pushfont(fltk3::Font f, fltk3::Fontsize s, fltk3::Color c) {
		fstack_.push(f, s, c);
	}
	void popfont(fltk3::Font &f, fltk3::Fontsize &s, fltk3::Color &c) {
		fstack_.pop(f, s, c);
	}
...
public:
	...
	void		textcolor(fltk3::Color c) {
		if (textcolor_ == defcolor_) textcolor_ = c;
		defcolor_ = c;
	}
...
//
// End of "$Id: HelpView.h 9300 2012-03-23 20:36:00Z ianmacarthur $".
//
